...
Mass spectra are returned in `long` format (one row per scan–m/z pair) with three columns: retention time, m/z, and intensity.

The examples use a 'Varian' SMS file from the `chromConverterExtraTests` repository.
