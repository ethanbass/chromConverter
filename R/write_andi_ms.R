...
#' Defaults to `FALSE`.
#' @param ms_params A list of instrument settings recorded in the file, since
#' they cannot be derived from the data: `ionization_mode`,
#' `ionization_polarity` and `detector_type`.
